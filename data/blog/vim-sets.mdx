...
`set wrap`does what it says. `set linebreak` makes sure that the line break doesn't chop any word in half as it wraps. `set breakindent` makes wrapped lines start at the same indent as the original line that was broken.
