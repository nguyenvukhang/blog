  ...
  return (
    <div className="bg-white dark:bg-black">
      <Head>
        ...
        <meta property="og:url" content={`https://nguyenvukhang.com${router.asPath}`} />
        <link rel="canonical" href={`https://nguyenvukhang.com${router.asPath}`} />
      ...
      <nav className="flex items-center justify-between w-full max-w-4xl px-8 py-6 mx-auto my-0 text-gray-900 bg-white sticky-nav md:my-8 dark:bg-black bg-opacity-60 dark:text-gray-100">
        ...
        <div>
          ...
          <NextLink href="/photos">
            <a className="px-1.5 text-gray-900 sm:p-4 dark:text-gray-100">Photos</a>
          </NextLink>
          <NextLink href="/about">
            <a className="px-1.5 text-gray-900 sm:p-4 dark:text-gray-100">About</a>
          </NextLink>
          <NextLink href="/">
            <a className="px-1.5 text-gray-900 sm:p-4 dark:text-gray-100">Home</a>
          </NextLink>
        </div>
      </nav>
      <main
