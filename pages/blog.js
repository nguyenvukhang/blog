      ...
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <div className="relative w-full mb-4">
          <input
            ...
            className="px-4 py-2 border border-gray-300 dark:border-gray-700 focus:ring-blue-500 focus:border-blue-500 block w-full rounded-md bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100"
          />
          <svg
